...
@section('contents')
    ...
    <div class="md:flex block items-center justify-between mb-6 mt-[2rem]  page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">User Management - Create User</h5>
            <nav>
                <ol class="flex items-center whitespace-nowrap min-w-0">
                    ...
                    <li class="text-[12px]"> <a class="flex items-center text-textmuted" href="javascript:void(0);">Create
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST">
                        ...
                        <div class = "flex justify-end mt-6">
                            <button type="submit" class="ti-btn ti-btn-primary-full ti-btn-wave  me-[0.375rem]">Save
                                User</button>
                        </div>
                    </form>
